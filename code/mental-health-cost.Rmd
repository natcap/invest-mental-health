...
ggsave(filename = './figures/mental_cost.png', plot = last_plot(), width = 7, height = 10, units = 'in', dpi = 300, bg = NULL)
```
...
ggsave(filename = './figures/mental_cost_select.png', plot = last_plot(), width = 7, height = 10, units = 'in', dpi = 300, bg = NULL)
```
