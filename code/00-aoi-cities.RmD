...
census_api_key('4d734dc264114e78500871cc76a9cf90928b1371', install = TRUE, overwrite = TRUE)
```
...
map <- 
  tm_shape(data) + 
  tm_polygons(col = "estimate", lwd = 0.2, col_alpha = 0.3, alpha = 0.5, legend.show = T) +
  # tm_shape(ua.i) + 
