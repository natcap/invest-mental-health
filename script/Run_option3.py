...
from lulc_ndvi_analysis import run_ndvi_option3_pipeline
from Health_cost import CostTableSelector,default_paths_option3
import os

class Option3GUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Option 3 Display")
        ...
        self.input_labels = [
            ...
            "NDVI Raster Baseline:", "NDVI Raster Scenario:",
            "Land Cover Raster Baseline:", "Land Cover Raster Scenario:",
            "Baseline Risk Shapefile:", "Health Effect Excel Table:", "Output Folder:"
        ]
        self.input_entries = []
        default_paths = default_paths_option3
    ...
    def handle_run(self):
        ...
        (aoi_path, tract_path, pop_raster_path,
         ndvi_2011_path, ndvi_2021_path,
         lc_2011_path, lc_2021_path,
         risk_path, health_effect_path, output_dir) = paths
        ...
        if self.run_count == 1:
            ...
            run_ndvi_option3_pipeline(
                aoi_path=aoi_path,
                ndvi_2011_path=ndvi_2011_path,
                ndvi_2021_path=ndvi_2021_path,
                lc_2011_path=lc_2011_path,
                lc_2021_path=lc_2021_path,
            ...
            paths = ["Figure_1.png", "Figure_2.png", "Figure_3.png", "Figure_4.png"]
            locations = [
            ...
            paths = ["Figure_5.png", "Figure_7.png", "Figure_6.png"]
            locations = [
                (self.right_plot_frame_top, "left"), (self.right_plot_frame_top, "right"),
